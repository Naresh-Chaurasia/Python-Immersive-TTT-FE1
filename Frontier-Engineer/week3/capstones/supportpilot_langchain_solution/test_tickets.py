"""
SupportPilot (LangChain edition) — same 8 test scenarios as the original
solution, run through the LangChain-based pipeline.
"""
...
TEST_CASES = [
    {"name": "1. Happy path - order status", "ticket_id": "T001", "customer_id": "CUST001",
     "text": "Hi, can you tell me the status of my recent order? It hasn't arrived yet.",
     "expect": "auto_resolved"},
    {"name": "2. Refund, in-policy", "ticket_id": "T002", "customer_id": "CUST003",
     "text": "I'd like a refund for my recent purchase, it doesn't fit well.",
     "expect": "auto_resolved"},
    {"name": "3. Refund, high-value (CUST002's only order is 6500)", "ticket_id": "T003", "customer_id": "CUST002",
     "text": "I want a refund on my recent order please.",
     "expect": "escalated"},
    {"name": "4. Fraud-adjacent, direct phrasing", "ticket_id": "T004", "customer_id": "CUST005",
     "text": "There's a transaction on my account that I don't recognize at all.",
     "expect": "escalated"},
    {"name": "5. Same fraud case, softened rephrasing", "ticket_id": "T005", "customer_id": "CUST005",
     "text": "Hey, quick one - I noticed a small charge on my account, just wanted to double check, I'm not sure it was me.",
     "expect": "escalated"},
    {"name": "6. Ambiguous / ultra-short ticket -> low confidence", "ticket_id": "T006", "customer_id": "CUST006",
     "text": "hey issue",
     "expect": "escalated"},
    {"name": "7. Angry customer, critical urgency", "ticket_id": "T007", "customer_id": "CUST004",
     "text": "This is absolutely unacceptable, I am furious about how this has been handled, I want a manager.",
     "expect": "escalated"},
    {"name": "8. No matching KB policy (off-topic, general inquiry)", "ticket_id": "T008", "customer_id": "CUST011",
